1. Line 12 prints the current value of i, which is 3 to the console.  The variable i keeps track of the number of iterations of the for loop which is determined by the length of the input array 'prices'.
